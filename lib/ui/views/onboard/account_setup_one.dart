...
class AccountSetupOne extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final onboardModel = Provider.of<OnboardModel>(context);
    ...
    return Column(
      ...
      children: [
        ...
        CustomTextField(
          ...
          onChanged: onboardModel.changeBusinessName,
          errorText: onboardModel.name.error,
        ),
        SizedBox(height: 20),
        Text(
        ...
        CustomTextArea(
          color: Colors.white,
          keyboardType: TextInputType.text,
          onChanged: onboardModel.changeDescription,
          errorText: onboardModel.description.error,
        ),
        SizedBox(height: 20),
      ],
    );
